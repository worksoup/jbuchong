...
class JBuChongKtFunc12<in A, in B, in C, in D, in E, in F, in G, in H, in I, in J, in K, in L, out R>(private var func: JBuChongKtFunc11<Pair<A, B>, C, D, E, F, G, H, I, J, K, L, R>) :
